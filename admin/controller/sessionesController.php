...
class sessionesController extends baseControl {
    ...
    public function index() {
        ...
        include("view/sessiones_index.php");
        include("view/_footer.php");
    }

    public function ver() {
        $sale = $this->obj->ver($this->valor[0]);
        $saleancheta = $this->obj->verancheta($this->valor[0]);
        include("view/_header.php");
        include("view/sessiones_ver.php");
        include("view/_footer.php");
    }
    ...
    public function agregar() {
        include("view/_header.php");
        include("view/sessiones_agregar.php");
        include("view/_footer.php");
    }
    ...
    public function agregando() {
        ...
        header("Location: " . PATO . "sessiones/");
        exit;
    }
    ...
    public function editar() {
        ...
        include("view/_header.php");
        include("view/sessiones_editar.php");
        include("view/_footer.php");
    }
