<?php
class types2Controller extends baseControl {
	...
	public function __construct(){
		veraut();
		include_once("model/types2Model.php");$this->obj = new types2Model();
	}

	public function index(){
		if($this->obj->cantidad()<10001){$sale = $this->obj->listar();$msg=1;}else{$sale=new nada();$msg=2;}
		include("view/_header.php");
		include("view/types2_index.php");
	...
	public function agregar(){
		include("view/_header.php");
		include("view/types2_agregar.php");
		include("view/_footer.php");
	}
	...
	public function agregando(){
		...
		header("Location: ".PATO."types2/");exit;
	}

	public function editar(){
		$sale = $this->obj->editar($this->valor[0]);
		include("view/_header.php");
		include("view/types2_editar.php");
		include("view/_footer.php");
	}
