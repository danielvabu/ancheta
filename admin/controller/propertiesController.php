<?php
class propertiesController extends baseControl {
	...
	public function __construct(){
		veraut();
		include_once("model/propertiesModel.php");$this->obj = new propertiesModel();
	}

	public function index(){
		if($this->obj->cantidad()<10001){$sale = $this->obj->listar();$msg=1;}else{$sale=new nada();$msg=2;}
		include("view/_header.php");
		include("view/properties_index.php");
	...
	public function ver(){
		...
		include("view/_header.php");
		include("view/properties_ver.php");
		include("view/_footer.php");
	}
	...
	public function agregar(){
		include("view/_header.php");
		include("view/properties_agregar.php");
		include("view/_footer.php");
	}
	...
	public function agregando(){
		...
		header("Location: ".PATO."properties/");exit;
	}

	public function editar(){
		$sale = $this->obj->editar($this->valor[0]);
		include("view/_header.php");
		include("view/properties_editar.php");
		include("view/_footer.php");
	}
