<?php
class enumvaluesController extends baseControl {
	...
	public function __construct(){
		veraut();
		include_once("model/enumvaluesModel.php");$this->obj = new enumvaluesModel();
	}

	public function index(){
		if($this->obj->cantidad()<10001){$sale = $this->obj->listar();$msg=1;}else{$sale=new nada();$msg=2;}
		include("view/_header.php");
		include("view/enumvalues_index.php");
	...
	public function ver(){
		...
		include("view/_header.php");
		include("view/enumvalues_ver.php");
		include("view/_footer.php");
	}
	...
	public function agregar(){
		include("view/_header.php");
		include("view/enumvalues_agregar.php");
		include("view/_footer.php");
	}
	...
	public function agregando(){
		...
		header("Location: ".PATO."enumvalues/");exit;
	}

	public function editar(){
		$sale = $this->obj->editar($this->valor[0]);
		include("view/_header.php");
		include("view/enumvalues_editar.php");
		include("view/_footer.php");
	}
