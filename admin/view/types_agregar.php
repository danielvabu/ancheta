...
<h4><?php echo __("Nuevo Typ"); ?></h4>

<form id="types-agregando" name="types-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>types/agregando/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#types-agregando").submit(function(){
