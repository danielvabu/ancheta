<h4><?php echo __("Editar Properties"); ?></h4>

<form id="properties2-editando" name="properties2-editando" class="form-horizontal" method="post" action="<?php echo PATO; ?>properties2/editando/<?php echo $this->valor[0]; ?>/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#properties2-editando").submit(function(){
