<h4><?php echo __("Editar Types"); ?></h4>

<form id="types2-editando" name="types2-editando" class="form-horizontal" method="post" action="<?php echo PATO; ?>types2/editando/<?php echo $this->valor[0]; ?>/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#types2-editando").submit(function(){
