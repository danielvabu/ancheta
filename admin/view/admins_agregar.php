...
<h4><?php echo __("Nuevo Administrador"); ?></h4>

<form id="admins-agregando" name="admins-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>admins/agregando/" enctype="multipart/form-data">
...
<div class="form-group row">
<label for="usuario" class="col-2"><?php echo __("Usuario"); ?></label>
<div class="col-7"><input id="usuario" name="usuario" type="text" class="form-control" data-placement="right" data-original-title="<?php echo __("Dato requerido"); ?>" data-content="<?php echo __("Por favor escriba el Usuario"); ?>" required /></div>
</div>


<div class="form-group row">
<label for="clave" class="col-2"><?php echo __("Clave"); ?></label>
<div class="col-7"><input id="clave" name="clave" type="text" class="form-control" data-placement="right" data-original-title="<?php echo __("Dato requerido"); ?>" data-content="<?php echo __("Por favor escriba el Clave"); ?>" required /></div>
</div>
...
<div class="form-group row">
	<div class="col-2"><button type="button" class="btn btn-secondary btn-block" onClick="window.history.back();" style="margin-top:10px;"><i class="fas fa-chevron-left"></i>&nbsp;&nbsp;<?php echo __("Volver"); ?></button></div>
...
$(function(){
	...
	$("#admins-agregando").submit(function(){
