...
<h4><?php echo __("Nuevo Enumvalues"); ?></h4>

<form id="enumvalues2-agregando" name="enumvalues2-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>enumvalues2/agregando/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#enumvalues2-agregando").submit(function(){
