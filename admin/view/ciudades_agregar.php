...
<h4><?php echo __("Nuevo Ciudad"); ?></h4>

<form id="ciudades-agregando" name="ciudades-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>ciudades/agregando/" enctype="multipart/form-data">
...
<div class="col-7"><input id="url" name="url" type="text" class="form-control" data-placement="right" data-original-title="<?php echo __("Dato requerido"); ?>" data-content="<?php echo __("Por favor escriba el Url"); ?>" required /></div>
</div>
...
$(function(){
	...
	$("#ciudades-agregando").submit(function(){
