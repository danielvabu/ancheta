...
<div>
<h4><?php echo __("Enumvalues2"); ?> <span class="badge badge-primary"><?php if(isset($sale->_numOfRows)){echo $sale->_numOfRows;}else{echo "0";} ?></span></h4>

<nav class="navbar navbar-default" role="navigation">
<div class="navbar-header">

<form action="<?php echo PATO; ?>enumvalues2/filtrar/" method="post" name="enumvalues2-filtrar" id="enumvalues2-filtrar" class="form-inline navbar-text">
...
if($msg==1)echo __("No hay Enumvalues2");
if($msg==2)echo __("Para ver resultados por favor filtre primero");
?></div></div><?php }else{ ?>
<div class="table-responsive"><table border="0" id="tb_sale_enumvalues2" class="table table-bordered table-striped table-hover table-condensed">
<thead>
	<tr class="hidden">
...
<a href="<?php echo PATO; ?>enumvalues2/ver/<?php echo $sale->fields["id"]; ?>/" data-toggle="tooltip" title="<?php echo __("Ver"); ?>" class="btn btn-default"><i class="fas fa-eye"></i></a>

<a href="<?php echo PATO; ?>enumvalues2/editar/<?php echo $sale->fields["id"]; ?>/" data-toggle="tooltip" title="<?php echo __("Editar"); ?>" class="btn btn-default"><i class="fas fa-edit"></i></a>
...
$(function(){
	...
	$("#tb_sale_enumvalues2").tablesorter({headers: {0: {sorter: false}}, widgets: ["zebra"]});
...
function eliminarenumvalues2(a){
	confirma1('<?php echo iinterro().__("Esta seguro de eliminar Enumvalues?"); ?>','<?php echo __("Si"); ?>','eliminandoenumvalues2',a)}
function eliminandoenumvalues2(a){window.location.href = "<?php echo PATO; ?>enumvalues2/eliminar/"+a+"/";}
</script><?php } ?>

<form class="form-inline">

<div class="form-group"><button type="button" class="btn btn-primary form-control" onClick="location.href='<?php echo PATO; ?>enumvalues2/agregar/';"><i class="fas fa-plus"></i>&nbsp;&nbsp;<?php echo __("Nuevo"); ?></button></div>
