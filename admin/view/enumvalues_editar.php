<h4><?php echo __("Editar Enumvalu"); ?></h4>

<form id="enumvalues-editando" name="enumvalues-editando" class="form-horizontal" method="post" action="<?php echo PATO; ?>enumvalues/editando/<?php echo $this->valor[0]; ?>/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#enumvalues-editando").submit(function(){
