...
<h4><?php echo __("Nuevo Properti"); ?></h4>

<form id="properties-agregando" name="properties-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>properties/agregando/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#properties-agregando").submit(function(){
