<h4><?php echo __("Ver enumvalues2"); ?></h4>
...
<div class="row">
	<div class="col-5"><?php echo __("N"); ?></div>
	<div class="col-7"><?php echo $sale->fields["n"]; ?>	</div>
</div>
...
<div class="row">
	<div class="col-5"><?php echo __("Etiqueta"); ?></div>
	<div class="col-7"><?php echo $sale->fields["etiqueta"]; ?>	</div>
</div>
