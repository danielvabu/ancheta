...
<div>
<h4><?php echo __("Enumvalues"); ?> <span class="badge badge-primary"><?php if(isset($sale->_numOfRows)){echo $sale->_numOfRows;}else{echo "0";} ?></span></h4>

<nav class="navbar navbar-default" role="navigation">
<div class="navbar-header">

<form action="<?php echo PATO; ?>enumvalues/filtrar/" method="post" name="enumvalues-filtrar" id="enumvalues-filtrar" class="form-inline navbar-text">
...
if($msg==1)echo __("No hay Enumvalues");
if($msg==2)echo __("Para ver resultados por favor filtre primero");
?></div></div><?php }else{ ?>
<div class="table-responsive"><table border="0" id="tb_sale_enumvalues" class="table table-bordered table-striped table-hover table-condensed">
<thead>
	<tr class="hidden">
...
<a href="<?php echo PATO; ?>enumvalues/ver/<?php echo $sale->fields["id"]; ?>/" data-toggle="tooltip" title="<?php echo __("Ver"); ?>" class="btn btn-default"><i class="fas fa-eye"></i></a>

<a href="<?php echo PATO; ?>enumvalues/editar/<?php echo $sale->fields["id"]; ?>/" data-toggle="tooltip" title="<?php echo __("Editar"); ?>" class="btn btn-default"><i class="fas fa-edit"></i></a>
...
$(function(){
	...
	$("#tb_sale_enumvalues").tablesorter({headers: {0: {sorter: false}}, widgets: ["zebra"]});
...
function eliminarenumvalues(a){
	confirma1('<?php echo iinterro().__("Esta seguro de eliminar Enumvalu?"); ?>','<?php echo __("Si"); ?>','eliminandoenumvalues',a)}
function eliminandoenumvalues(a){window.location.href = "<?php echo PATO; ?>enumvalues/eliminar/"+a+"/";}
</script><?php } ?>

<form class="form-inline">

<div class="form-group"><button type="button" class="btn btn-primary form-control" onClick="location.href='<?php echo PATO; ?>enumvalues/agregar/';"><i class="fas fa-plus"></i>&nbsp;&nbsp;<?php echo __("Nuevo"); ?></button></div>
